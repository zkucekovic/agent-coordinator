...
def create_task_interactive(workspace: Path, use_editor: bool = True) -> dict[str, Any]:
    ...
    from agent_coordinator.infrastructure.enhanced_input import enhanced_input, enhanced_multiline, Colors
...
def main_task() -> None:
    ...
    if not args.no_handoff:
        ...
        print(f"  2. Create or update handoff.md")
