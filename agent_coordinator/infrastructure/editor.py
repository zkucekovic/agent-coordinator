...
def edit_specification() -> dict[str, str]:
    """
...
"""
    ...
    for line in lines:
        if line.strip():
            result['title'] = line.strip().replace('#', '').strip()
            break
    ...
    for line in lines[1:]:
        ...
        if line_stripped.startswith('## Description'):
            ...
            result['requirements'].append(line_stripped[1:].strip())
        elif current_section == 'constraints' and line_stripped.startswith('-'):
            result['constraints'].append(line_stripped[1:].strip())
...
"""
    ...
    for line in lines[1:]:
        ...
        if line_stripped.startswith('## Acceptance'):
            ...
            result['acceptance_criteria'].append(line_stripped[1:].strip())
        elif current_section == 'dependencies' and line_stripped.startswith('-'):
            result['dependencies'].append(line_stripped[1:].strip())
