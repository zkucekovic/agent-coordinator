...
class TestGenericRunner(unittest.TestCase):
    ...
    def test_text_output_format(self, mock_run):
        ...
        mock_run.return_value = PtyResult(returncode=0, stdout="Agent response text", stderr="")
    ...
    def test_command_building_with_all_args(self, mock_run):
        ...
        mock_run.return_value = PtyResult(returncode=0, stdout="response", stderr="")
    ...
    def test_error_handling_nonzero_exit(self, mock_run):
        ...
        mock_run.return_value = PtyResult(returncode=1, stdout="", stderr="Command failed")
